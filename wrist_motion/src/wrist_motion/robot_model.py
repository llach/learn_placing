"""
Slightly modified version of Robert's original RobotModel class.

Additions:
* ignore joints by name during parsing
* deactivate joints in FK 
* more checks during URDF parsing
"""
...
class RobotModel():
    def __init__(self, param='robot_description', ignore_joints=[]):
        ...
        self.disabled_joints = [] # a bit hacky as they appear in active joints, too
    ...
    def fk(self, link, joints):
        ...
        def index(joint):
            ...
            if joint in self.disabled_joints:
                return None, 1.0
            if joint.mimic is None:
